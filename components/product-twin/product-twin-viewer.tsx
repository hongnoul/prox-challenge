...
const evidenceLabels: Record<string, string> = {
  "owner-manual-page-8": "Owner’s Manual p. 8",
  "owner-manual-page-14": "Owner’s Manual p. 14",
  "owner-manual-page-16": "Owner’s Manual p. 16",
  "product-front-photo": "supplied product photo",
};
